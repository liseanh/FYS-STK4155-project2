...
The aim of this project is to implement and use  logistic regression and a multilayer perceptron (MLP) to classify data \textbf{PLEASE SPECIFY WHAT KIND OF DATA}  and to further use the MLP to perform regression analysis on Franke's function. 
