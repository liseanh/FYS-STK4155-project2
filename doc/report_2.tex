...
Logistic regression (LR)  is a statistical model that can be used to predict a binary dependent variable.
Sigmoid function
\begin{equation}
...
\begin{table}[H]
    ...
    \hline
 	   Method & \makecell[l]{Error \\rate} & \makecell[l]{Area ratio \\default} & \makecell[l]{Area ratio \\non-default} \\ 			\hline
    		LR & 0.310 & 0.459 & 0.132 \\ \hline
    		NN & 0.21  & 0.545 & 0.157 \\ \hline
    	\end{tabular}
	}
\end{table}
