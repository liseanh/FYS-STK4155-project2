...
\begin{figure}[H]
	...
	\caption{Accuracy score of validation set for randomized search of the shrinkage parameter $\lambda$ and learning rate $\eta$ for the multilayer perceptron classification analysis.}
\end{figure}


\begin{figure}[H]
	\includegraphics[scale=1]{figures/logreg_learning_rate_accuracy.pdf}
	\caption{Accuracy score of validation set for randomized search of the learning rate $\eta$ for logistic regression.}
\end{figure}
